  ...
  return (
    <div>
      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-gold-400/10 pb-6">
        <div>
          <h1 className="font-display text-3xl font-light text-ivory">
            Store <span className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-gold-100 via-gold-200 to-gold-400">Categories</span>
          </h1>
          <p className="text-sm text-ivory/50 font-light mt-1">Organize fragrances by concentration or collection.</p>
        </div>
        <Link
      ...
      <div className="hidden overflow-x-auto rounded-[2rem] border border-gold-400/10 bg-gradient-to-b from-ink-soft/80 to-ink-soft/30 p-6 backdrop-blur-md shadow-2xl sm:block md:p-8">
        {categories.length === 0 ? (
          <p className="py-12 text-center text-sm text-ivory/40">No categories yet — create your first one.</p>
        ) : (
