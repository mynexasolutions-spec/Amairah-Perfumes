...
export default function VariantsEditor({ variants, onChange, showErrors }) {
  ...
  const add = () => {
    onChange([...variants, { variant_name: "", price: "", original_price: "", stock_quantity: "" }]);
  };
  ...
  return (
    <div className="space-y-3">
      {variants.map((v, i) => {
        ...
        return (
          <div key={i} className="grid grid-cols-1 gap-2 rounded-xl border border-ink-line p-3 sm:grid-cols-[1fr_1fr_1fr_1fr_auto]">
            <div>
              <input
