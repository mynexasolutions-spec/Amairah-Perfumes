      ...
      <div className="relative overflow-hidden rounded-[2rem] border border-gold-400/25 bg-ink-soft/80 p-8 text-center shadow-gold/10 backdrop-blur-md md:p-12 animate-fadeUp">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <button
            ...
            className="rounded-full border border-gold-400/30 bg-ink-soft px-8 py-3 text-xs font-semibold uppercase tracking-wider text-ivory hover:border-gold-300 hover:bg-gold-400/5 transition-all"
          >
    ...
    <div className="relative rounded-[2rem] border border-gold-400/10 bg-gradient-to-br from-ink-soft/90 via-ink-soft/60 to-ink/80 p-6 shadow-2xl backdrop-blur-md md:p-10 hover:border-gold-400/20 transition-all duration-500 hover:shadow-[0_0_50px_rgba(212,163,89,0.04)]">
      ...
      <div className="mb-8">
        <div className="flex flex-wrap items-center justify-between gap-x-3 gap-y-2 mb-2">
          <span className="inline-flex items-center gap-2 text-[10px] font-semibold uppercase tracking-widest text-gold-300">
      ...
      <form action={formAction} className="space-y-6">
        ...
        {/* Topic Pills */}
        <div>
          <label className="block text-[10px] font-semibold uppercase tracking-wider text-ivory/50 mb-3">
            Select Topic
          </label>
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-[10px] font-semibold uppercase tracking-wider text-ivory/50 mb-2">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-gold-400/10 bg-ink/40 px-4 py-4 text-sm text-ivory placeholder:text-ivory/20 transition-all duration-500 focus:border-gold-400/50 focus:bg-ink/70 focus:outline-none focus:ring-1 focus:ring-gold-400/20 hover:border-gold-400/20"
            />
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="block text-[10px] font-semibold uppercase tracking-wider text-ivory/50">
            ...
            <textarea
              ...
              className="w-full rounded-2xl border border-gold-400/10 bg-ink/40 px-4 py-4 text-sm text-ivory placeholder:text-ivory/20 transition-all duration-500 focus:border-gold-400/50 focus:bg-ink/70 focus:outline-none focus:ring-1 focus:ring-gold-400/20 resize-none hover:border-gold-400/20"
            />
          </div>
        </div>
        ...
        <button
          type="submit"
          disabled={pending}
          className="btn-gold group w-full sm:w-fit px-8 py-4 text-xs font-semibold tracking-widest uppercase transition-all duration-500 disabled:opacity-60 shadow-[0_4px_20px_rgba(212,163,89,0.1)] hover:shadow-[0_4px_25px_rgba(212,163,89,0.25)] hover:-translate-y-0.5"
        >
          {pending ? (
